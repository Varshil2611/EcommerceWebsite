  ...
  if (error || !product) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-semibold text-gray-700">{error || 'Product not found'}</h2>
        <button
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start relative">
        ...
        <div className="flex flex-col relative z-20 mt-4 md:mt-0" data-aos="fade-left">
          ...
          <h2 className="text-3xl font-extrabold text-gray-800 mb-4" data-aos="zoom-in">{product.name}</h2>
          <p className="text-lg text-gray-600 mb-6" data-aos="fade-up">{product.description}</p>
          <p
          ...
          {/* Product Details Section */}
          <div className="mt-12 border-t pt-8" data-aos="fade-up">
